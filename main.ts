...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    ...
    info.changeScoreBy(randint(2, 10))
})
function doCrate () {
...
sprites.onOverlap(SpriteKind.Crate, SpriteKind.Chest, function (sprite, otherSprite) {
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorOpenWest, function (sprite, location) {
    if (info.score() == 10) {
        ...
        game.splash("Not ENOUGHT MONEY")
    }
})
let Count = 0
let callSpawnCrate = 0
let mySprite2: Sprite = null
let mySprite3: Sprite = null
let mySprite: Sprite = null
game.splash("Throne Into a dungeon you use your strength to carry and sell resources")
color.setPalette(
color.Black
)
color.setPalette(
...
mySprite3 = sprites.create(assets.image`myImage`, SpriteKind.Chest)
controller.moveSprite(mySprite, 100, 100)
doCrate()
info.setScore(0)
scene.cameraFollowSprite(mySprite)
tiles.setCurrentTilemap(tilemap`The Start1`)
